  ...
  return (
    <div className="w-full">
      <div
        ...
        className={`relative w-full max-w-5xl mt-4 lg:mt-6 overflow-hidden rounded-3xl ${isFullscreenMode
      ...
      >
        <div
          ...
          className={`relative ${isFullscreenMode
                ...
                <div className="flex-1 flex items-center mx-1">
                  <input
                    ...
                    style={{
                      ...
                      background: `linear-gradient(to right, #3b82f6 0%, #3b82f6 ${(cleanVimeoCurrentTime / (cleanVimeoDuration || 1)) *

                        100

                        }%, rgba(255,255,255,0.3) ${(cleanVimeoCurrentTime / (cleanVimeoDuration || 1)) *
