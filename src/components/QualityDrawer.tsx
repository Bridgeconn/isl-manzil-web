...
const QualityDrawer: React.FC<QualityDrawerProps> = ({
  ...
  return (
    <div className="absolute space-y-2 max-h-70 overflow-y-auto pr-1 custom-scrol bottom-16 h-65 right-4 w-48 p-4 rounded-lg bg-black bg-opacity-90 text-white shadow-lg z-50">
      <div>
        <div className="flex  items-center mb-4">
          ...
          />
          <span className="text-lg font-semibold ml-4 ">Quality</span>
        </div>
