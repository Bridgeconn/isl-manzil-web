...
const SettingsDrawer: React.FC<SettingsDrawerProps> = ({
  ...
  return (
    <div className="absolute bottom-10 md:bottom-12 right-4 bg-black bg-opacity-90 text-white rounded-lg shadow-lg w-45 md:w-48 p-3 z-50">
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <div className="flex items-center gap-1 text-sm text-gray-300 leading-none">
            <span className="ml-2">
