...
const SharePopup: React.FC<SharePopupProps> = ({ shareUrl }) => {
  ...
  return (
    <>
      ...
      <div className="absolute bottom-11 right-2 sm:right-4 w-58 sm:w-68 bg-white border border-gray-200 rounded-lg shadow-xl p-3 sm:p-4 z-50">
        {/* URL Display */}
        ...
        <div className="flex justify-center gap-2 sm:gap-4">
          <FacebookShareButton url={shareUrl}>
            <FacebookIcon size={28} className="sm:w-8 sm:h-8" round />
          </FacebookShareButton>
          ...
          <EmailShareButton url={shareUrl}>
            <EmailIcon size={28} className="sm:w-8 sm:h-8" round />
          </EmailShareButton>
